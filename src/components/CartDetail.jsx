        ...
        <div className="w-full min-h-[80vh] bg-white px-10 py-10">
          {cart.length ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center gap-8">
              <h1 className="font-semibold text-2xl md:text-4xl">No hay productos en el carrito.</h1>
              <Link
                to="/"
                className="font-medium text-black rounded-full border-2 border-blue-600 md:text-lg md:font-semibold px-10 py-4 hover:bg-blue-600 hover:text-white"
              >
                Volver a la tienda
              </Link>
            </div>
